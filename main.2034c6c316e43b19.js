...
_class.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_14__["ɵɵdefineInjector"]({
  imports: [_angular_router__WEBPACK_IMPORTED_MODULE_15__.RouterModule.forRoot([{
    path: '',
...
/* harmony import */ var primeng_sidebar__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! primeng/sidebar */ 5026);
/* harmony import */ var primeng_badge__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! primeng/badge */ 7650);
/* harmony import */ var primeng_radiobutton__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! primeng/radiobutton */ 3313);
/* harmony import */ var primeng_inputswitch__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! primeng/inputswitch */ 1763);
/* harmony import */ var primeng_ripple__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! primeng/ripple */ 1339);
...
/* harmony import */ var primeng_panelmenu__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! primeng/panelmenu */ 5897);
...
/* harmony import */ var primeng_menu__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! primeng/menu */ 5518);
/* harmony import */ var primeng_button__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! primeng/button */ 2947);
...
/* harmony import */ var primeng_dropdown__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! primeng/dropdown */ 4553);
/* harmony import */ var primeng_fieldset__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! primeng/fieldset */ 6681);
/* harmony import */ var primeng_fileupload__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! primeng/fileupload */ 8285);
...
function FacturaReaderComponent_div_13_ng_template_9_Template(rf, ctx) {
  if (rf & 1) {
...
function FacturaReaderComponent_div_13_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
...
function FacturaReaderComponent_div_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](6, "N de la factura:");
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
...
class FacturaReaderComponent {
  ...
  subirImagen() {
    ...
    return (0,_home_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      // this.subcripciones.push(
      //   this.tareaService
      //     .subirImagenLineaTarea({ id: this.tareaID, imagen: this.imagenSubida })
      //     .subscribe({
      //       next: (response) => {
      //         this.messageService.add({
      //           severity: 'success',
  ...
  borrarImagen(id) {
    ...
    // this.subcripciones.push(
    //   this.tareaService.borrarImagenLineaTarea(id).subscribe({
    //     next: (response) => {
    //       this.messageService.add({
    //         severity: 'success',
    //         summary: 'Exito',
  ...
  buscarCabeceraFactura(textDeLaImagen) {
    const cabeceraKeys = ['cantidad', 'cant.', 'unidades', 'descripcion', 'producto', 'nombre', 'titulo', 'precio', 'precio unitario', 'valor', 'tarifa', 'precio total', 'total', 'importe'];
    let record = 0;
    let indiceRecord = 0;
    let i = 0;
    textDeLaImagen.data.lines.forEach(linea => {
      ...
      if (contCabecera > record) {
        record = contCabecera;
        indiceRecord = i;
      }
      i++;
    });
    console.log('la cabecera con un record de (' + record + ') => ', textDeLaImagen.data.lines[indiceRecord]);
    return indiceRecord;
  }
